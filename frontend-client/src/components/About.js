            ...
            <div>
                <section className="jumbotron text-center">
                    <div className="container">
                        ...
                        <p className="lead text-muted mb-0">A few words about us and our
                            policies.</p>
                    </div>
                </section>
                <div className="container">
                ...
                <div className="container">
                    ...
                    <div className="card"
                        ...
                        <div className="card-body">
                            ...
                            <p>These Website Standard Terms and Conditions written on this
                                webpage shall manage your use of our website, TurTech.com
                                accessible at www.turtech.com.</p>

                            <p>These Terms will be applied fully and affect to your use of
                                this Website. By using this Website, you agreed to accept all terms
                            ...
                            <p>Other than the content you own, under these Terms, TurTech
                                and/or its licensors own all the intellectual property rights and
                                materials contained in this Website.</p>

                            <p>You are granted limited license only for purposes of viewing
                            ...
                            <ul>
                                ...
                                <li>using this Website in any way that is or may be damaging
                                    to this Website;
                                </li>
                            ...
                            <p>Certain areas of this Website are restricted from being
                                access by you and TurTech may further restrict access by you to any
                            ...
                            <p>In these Website Standard Terms and Conditions, "Your
                                Content" shall mean any audio, video text, images or other material
                                you choose to display on this Website. By displaying Your Content,
                                you grant TurTech a non-exclusive, worldwide irrevocable, sub
                            ...
                            <p>Your Content must be your own and must not be invading any
                                third-party’s rights. TurTech reserves the right to remove any of
                            ...
                            <p>This Website is provided "as is," with all faults, and
                                TurTech express no representations or warranties, of any kind
                            ...
                            <p>In no event shall TurTech, nor any of its officers, directors
                                ...
                                liability is under contract. TurTech, including its officers,
                            ...
                            <p>You hereby indemnify to the fullest extent TurTech from and
                            ...
                            <p>If any provision of these Terms is found to be invalid under
                            ...
                            <p>TurTech is permitted to revise these Terms at any time as it
                            ...
                            <p>The TurTech is allowed to assign, transfer, and subcontract
                    ...
                    <div className="card my-4"
                        ...
                        <div className="card-body">
                            <div className="container">
                                <h4>Introduction</h4>
                                <p>At TurTech.com, accessible from www.turtech.com, one of our
                                    ...
                                    and recorded by TurTech.com and how we use it.</p>

                                <p>If you have additional questions or require more information
                                    about our Privacy Policy, do not hesitate to contact us through
                                    email at turtech@gmail.com</p>
                                <hr/>

                                <h4>Log Files</h4>

                                <p>TurTech.com follows a standard procedure of using log files.
                                ...
                                <p>Like any other website, TurTech.com uses 'cookies'. These
                                ...
                                <p>You may consult this list to find the Privacy Policy for
                                    each of the advertising partners of TurTech.com.</p>

                                <p>Third-party ad servers or ad networks uses technologies like
                                    cookies, JavaScript, or Web Beacons that are used in their
                                    respective advertisements and links that appear on TurTech.com,
                                ...
                                <p>Note that TurTech.com has no access to or control over these
                                    cookies that are used by third-party advertisers.</p>
                                <hr/>

                                <h4>Third Party Privacy Policies</h4>

                                <p>TurTech.com's Privacy Policy does not apply to other
                                ...
                                <p>Another part of our priority is adding protection for
                                ...
                                <p>TurTech.com does not knowingly collect any Personal
                                ...
                                <p>This Privacy Policy applies only to our online activities
                                    and is valid for visitors to our website with regards to the
                                    information that they shared and/or collect in TurTech.com. This
